...
abstract class ActionScheduler_Abstract_ListTable extends WP_List_Table {
	...
	public function extra_tablenav( $which ) {
		...
		submit_button( esc_html__( 'Filter','carrot-bunnycdn-incoom-plugin' ), '', 'filter_action', false, array( 'id' => 'post-query-submit' ) );
		echo '</div>';
	}
	...
	protected function display_header() {
		...
		if ( $this->get_request_search_query() ) {
			...
			echo '<span class="subtitle">' . esc_attr( sprintf( __( 'Search results for "%s"','carrot-bunnycdn-incoom-plugin' ), $this->get_request_search_query() ) ) . '</span>';
		}
	...
	protected function get_search_box_placeholder() {
		return esc_html__( 'Search','carrot-bunnycdn-incoom-plugin' );
	}
