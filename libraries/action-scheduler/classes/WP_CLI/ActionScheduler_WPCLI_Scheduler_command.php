			...
			if ( is_subclass_of( $classname, ActionScheduler_Abstract_Schema::class ) ) {
				...
				WP_CLI::success(
					sprintf(
						...
						__( 'Registered schema for %s','carrot-bunnycdn-incoom-plugin' ),
						$classname
					)
				);
			}
	...
	protected function print_total_actions( $total ) {
		WP_CLI::log(
			sprintf(
				...
				_n( 'Found %d scheduled task', 'Found %d scheduled tasks', $total,'carrot-bunnycdn-incoom-plugin' ),
	...
	protected function print_total_batches( $batches_completed ) {
		WP_CLI::log(
			sprintf(
				...
				_n( '%d batch executed.', '%d batches executed.', $batches_completed,'carrot-bunnycdn-incoom-plugin' ),
	...
	protected function print_error( Exception $e ) {
		WP_CLI::error(
			sprintf(
				...
				__( 'There was an error running the action scheduler: %s','carrot-bunnycdn-incoom-plugin' ),
				$e->getMessage()
			)
		);
	}
	...
	protected function print_success( $actions_completed ) {
		WP_CLI::success(
			sprintf(
				...
				_n( '%d scheduled task completed.', '%d scheduled tasks completed.', $actions_completed,'carrot-bunnycdn-incoom-plugin' ),
